<template>
	<view class="s-page-wrapper is-100vh">
		<view class="is-33vh has-mgt-10 flex-center">
			<view class="is-flex is-column is-justify-center  is-align-center is-height-100">
				<image src="../../static/large.png" mode="aspectFit" class="logoimg"></image>
			</view>
		</view>
		<view class="content">
		...
		<view class="is-20vh has-mgt-80 content">
			<view style="float: left;color: #007AFF;" @click="goRegister()">立即注册</view>
