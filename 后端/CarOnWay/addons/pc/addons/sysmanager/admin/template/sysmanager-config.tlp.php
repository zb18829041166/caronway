                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
								<tr class="formtr">
                                    ...
                                    <td class="formtd">
                                 	<input type="text" class="common-text" name="config[pc_sysmanager_seo_title]" value="{$PW['pc_sysmanager_seo_title']}" size="36" />
                                    </td>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="config[pc_sysmanager_example]" value="{$PW['pc_sysmanager_example']}" size="36" />
                                    </td>
