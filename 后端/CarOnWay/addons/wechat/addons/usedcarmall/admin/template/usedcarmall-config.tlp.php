                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
								<tr class="formtr">
                                    ...
                                    <td class="formtd">
                                 	<input type="text" class="common-text" name="config[wechat_usedcarmall_seo_title]" value="{$PW['wechat_usedcarmall_seo_title']}" size="36" />
                                    </td>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="config[wechat_usedcarmall_example]" value="{$PW['wechat_usedcarmall_example']}" size="36" />
                                    </td>
