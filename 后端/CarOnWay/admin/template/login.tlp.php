...
<div class="admin_login_wrap">
    ...
    <p class="admin_copyright"><a tabindex="5" href="{__PW_PATH__}" target="_blank">返回首页</a> &copy; 2009 - {date('Y')} Powered by <a href="http://http://www.caronway.cn/CarOnWay/" target="_blank">车型路上</a></p>
</div>
</body>
</html>