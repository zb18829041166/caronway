...
<div class="common-width" style="overflow:auto;">
	...
	<div class="right-nav">
		...
		<table class="table-list-css" cellpadding="1" cellspacing="1">
			...
			<tr>
				<td><?php echo date('Y-m-d H:i:s',$r['creditstime']);?></td>
				<td><?php echo $r['inc']>0?'<font style="color:#009933;">增加</font>':'<font style="color:#FF3300;">减少</font>';?> <font style="color:#009933; font-weight:bold"><?php echo isset($r['credits'])?$r['credits']:'';?></font> 积分</td>
