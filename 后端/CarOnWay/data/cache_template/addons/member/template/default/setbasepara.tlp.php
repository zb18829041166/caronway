...
<form class="common-width" style="overflow:auto;">
    <div class="left-nav">
        <ul>
            ...
            <li><a href="<?php echo U(MOD,'setbasepara');?>">设置基础参数</a></li>
        </ul>
    </div>
    <div class="right-nav">
        <h1>基础参数设置</h1>
        <form action="<?php echo U(MOD,'setadministor');?>" name="setadministor" id="setadministor" method="post">
            <div class="form_text_ipt">
                <input name="telephone" id="telephone"  type="text" readonly value="<?php echo isset($data['telephone'])?$data['telephone']:'';?>">
            </div>
            <div class="form_text_ipt">
                <input name="username" id="username" type="text" readonly value="<?php echo isset($data['username'])?$data['username']:'';?>">
            </div>
            <div class="form_text_ipt">
