                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
								<tr class="formtr">
                                    ...
                                    <td class="formtd">
                                 	<input type="text" class="common-text" name="config[wechat_usedcarmall_seo_title]" value="<?php echo isset($PW['wechat_usedcarmall_seo_title'])?$PW['wechat_usedcarmall_seo_title']:'';?>" size="36" />
                                    </td>

                                </tr>
                                <!--
                                您可以无限拓展配置的选项 不过值请以 wechat_usedcarmall_ 开头，以防止跟其他模块选项值冲突
                                您可以在前台用 $PW['wechat_usedcarmall_example'] 读取这个选项

                                <tr class="formtr">
                                    <th class="formth" width="20%"><i class="require-red">*</i>选项：</th>
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="config[wechat_usedcarmall_example]" value="<?php echo isset($PW['wechat_usedcarmall_example'])?$PW['wechat_usedcarmall_example']:'';?>" size="36" />
                                    </td>
