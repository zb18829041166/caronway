...
<div class="admin_login_wrap">
    ...
    <p class="admin_copyright"><a tabindex="5" href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>" target="_blank">返回首页</a> &copy; 2009 - <?php echo date('Y');?> Powered by <a href="http://http://www.caronway.cn/CarOnWay/" target="_blank">车型路上</a></p>
</div>
</body>
</html>